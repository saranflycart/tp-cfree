					...
					<table class="table table-bordered">
						...
						<tr>
							<th colspan="<?php echo $count;?>" >
								<div class="center"><?php echo JText::_('J2STORE_PRODUCT_COMPARISON')?></div>
							</th>
						</tr>
						</thead>
								...
								<?php foreach($vars->products as $item):?>
									<td>
										...
										<?php if(JFile::exists(JPATH_SITE.'/'.JPath::clean($product_image))):?>
											<img alt="<?php echo $item->product_name ;?>" class="thumbnail j2store-productcompare-img j2store-productcompare-thumb-image-<?php echo $item->j2store_product_id; ?> img-responsive"								src="<?php echo $image_path.$product_image;?>" />
										<?php else:?>
											<img alt="<?php echo $item->product_name ;?>"							class="thumbnail j2store-productcompare-img j2store-productcompare-thumb-image-<?php echo $item->j2store_product_id; ?>"
								...
								<tr>
									...
									<?php foreach($vars->products as $item):?>
										<td><?php if(!empty($item->variant->sku)) : ?> <span
											 class="sku"> <?php echo $item->variant->sku; ?>
								</span> <?php endif; ?>
										</td>
									<?php endforeach;?>
								</tr>
