...
<div id="rs_event_show" class="event-show">

	<!-- Event Title -->
	<div class="event-title">
		<h1 class="rs-event-title <?php echo $full ? ' rs_event_full' : ''; ?><?php echo $ongoing ? ' rs_event_ongoing' : ''; ?><?php echo $featured; ?>"><?php echo $this->escape($event->name); ?></h1>
	</div>
	<!--//end Event Title -->
...
<div class="col-md-8 col-sm-8 col-xs-12 rspro-image">
	<!-- Image -->
	<?php if (!empty($details['image_b'])) { ?>
	<div class="rs_image">
		<a href="<?php echo $details['image']; ?>" class="rs_modal thumbnail" rel="">
...
<div class="col-md-4 col-sm-4 col-xs-12 rspro-content">
	<!-- Start / End date -->
	<?php if ($event->allday) { ?>
	...
	<div class="rs_clear"></div>
	<div class="rs_sharing col-sm-12 col-xs-12">	
	...
	<?php if (!empty($this->options['show_description']) && !empty($event->description)) { ?>
		<div class="description col-md-12 col-sm-12 col-xs-12"><?php echo $event->description; ?></div>
	...
	<!-- Google maps -->
	<?php if (!empty($this->options['show_map']) && !empty($event->coordinates) && rseventsproHelper::getConfig('enable_google_maps','int')) { ?>
		<div class="col-md-12 col-sm-12 col-xs-12"><div id="map-canvas" style="width: 100%; height: 250px;"></div></div>
		<div class="rs_clear"></div>
	<?php } ?>
	<!--//end Google maps -->
