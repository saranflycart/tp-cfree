...
?>
	<div class="row">
		<div class="col-sm-12 j2-tabs">
			<ul class="nav nav-tabs col-sm-2" id="j2store-product-detail-tab">
				<?php
				...
				if($this->params->get('item_show_sdesc') || $this->params->get('item_show_ldesc')):?>
					<li class="active"><a href="#description" data-toggle="tab"><i class="fa fa-caret-right"></i><?php echo JText::_('J2STORE_PRODUCT_DESCRIPTION')?></a>
				<?php endif;?>
				...
				<?php if($this->params->get('item_show_product_specification')):?>
					<li class="<?php echo isset($set_specification_active) && $set_specification_active ? 'active' : '';?>" >
						<a href="#specs" data-toggle="tab"><i class="fa fa-caret-right"></i><?php echo JText::_('J2STORE_PRODUCT_SPECIFICATIONS')?></a>
					</li>
				<?php endif;?>
			</ul>
