...
?>
	...
	<div class="j2-cart-plugin">
		...
		<?php else: ?>
			<span>Quantity: </span>	<input type="hidden" name="product_qty" value="<?php echo (int) $this->product->quantity; ?>" />
		<?php endif; ?>

			<input type="hidden" id="j2store_product_id-<?php echo $this->product->j2store_product_id; ?>" name="product_id" value="<?php echo $this->product->j2store_product_id; ?>" />
			<div class="j2cart">
				<input
